...
export const projects: Project[] = [
  {
    ...
    description:
      "A sleek travel website built with React, Next.js, and Tailwind CSS, featuring smooth animations, intuitive navigation, and a responsive design for exploring destinations and booking trips.",
    technologies: ["React", "Nextjs", "TailwindCss"],
    github: "https://github.com/Elmoustafi-22/travel-website",
    live: "https://travel-website-delta-three.vercel.app/",
  },
  {
    title: "Niyistores",
    description:
